    ...
    >
      ...
      <div className="flex flex-col gap-0.5 overflow-hidden w-full max-w-full h-full">
        <div className="flex-1 overflow-hidden">
          ...
          {/* Description line: Show custom description only if it's different from task type and either not in compact view or task spans 2 or more cells */}
          {(!compactView || visualRowSpan > 1) && task.taskDescription && task.taskDescription !== task.taskType ? (
