    ...
    <dialog className="modal modal-open">
      <div className="modal-box">
        ...
        <h3 className="font-bold text-lg mb-5">
          {isManager ? 'Edit Billing Rate' : editingUser ? 'Edit User' : 'Add New User'}
        </h3>

        {isManager ? (
          // Manager view - only show billing rate
          <>
        ...
        <div className="modal-action">
          ...
          <button className="btn btn-primary" onClick={onSave}>
            {isManager ? 'Save Rate' : editingUser ? 'Save Changes' : 'Add User'}
          </button>
        </div>
      </div>
